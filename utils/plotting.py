    ...
    for depth in depths:
        for variant in variants:
            ...
            try:
                ...
                # Get test data
                loaders = get_dataloaders(cfg, splits=("test",), as_simclr=False)
                ...
                with torch.no_grad():
                    for images, labels in test_loader:
                        ...
                        features = model.encode(images)  # Use encoder features for UMAP
                ...
                # Get primary label for each sample (first positive class)
                primary_labels = []
                for lbl in labels:
